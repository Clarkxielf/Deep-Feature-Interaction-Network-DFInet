...
inspection_data = sio.loadmat('blade1_S3_Inspection_data.mat')['Inspection_data'][:, :2]
...
'''Interpolation'''
segmented_data0 = inspection_data[:1718]
distance = 0.01
for _ in range(5):
    new_data = []
...
segmented_data1 = inspection_data[1718:3749]
distance = 0.01
for _ in range(5):
    new_data = []
...
segmented_data2 = inspection_data[3749:]
distance = 0.01
for _ in range(2):
    new_data = []
...
sio.savemat('result/blade1_S3_inference_data_test0.mat',
            {'Src': all_Src,
             'Ref': all_Ref,
             'Rot_mat': all_Rot_mat,
...
sio.savemat('result/blade1_S3_preprocess.mat',
...
sio.savemat('result/blade1_S3_inference_data_Segmented_idx.mat',
