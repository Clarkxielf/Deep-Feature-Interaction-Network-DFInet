...
inspection_data = sio.loadmat('blade1_S2_Inspection_data.mat')['Inspection_data'][:, :2]
...
'''Interpolation'''
segmented_data0 = inspection_data[:1680]
distance = 0.01
for _ in range(5):
    new_data = []
...
segmented_data1 = inspection_data[1680:3736]
distance = 0.01
for _ in range(5):
    new_data = []
...
segmented_data2 = inspection_data[3736:]
distance = 0.01
for _ in range(2):
    new_data = []
...
# if index_head+index_deviation+src_num<segmented_data0.shape[0]:
#     src = segmented_data0[index_head+index_deviation:index_head+index_deviation+src_num]
# else:
#     src = segmented_data0[-src_num:, :]
...
sio.savemat('result/blade1_S2_inference_data_test0.mat',
            {'Src': all_Src,
             'Ref': all_Ref,
             'Rot_mat': all_Rot_mat,
...
sio.savemat('result/blade1_S2_preprocess.mat',
...
sio.savemat('result/blade1_S2_inference_data_Segmented_idx.mat',
